export const dataBesar = {
  ...
  cache: {
    ...
    reason: "",
    group: "enabled",
    tags: ["group-edgeCacheHome"],
    serverVariantState:
      "44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a",
    middlewareEnabled: true,
    cacheStatus: "HIT",
    shouldUseCache: true,
    vary: ["enable_medium_app"]
  },
  client: {
    hydrated: true,
    isUs: false,
  ...
  config: {
    nodeEnv: "production",
    version: "main-20220329-025052-df36d6c591",
    ...
    authGoogleClientId:
      "216296035834-k1k6qe060s2tp2a2jam4ljdcms00sttg.apps.googleusercontent.com",
    favicon: "production",
    ...
    lightStep: {
      ...
      appVersion: "main-20220329-025052-df36d6c591",
      disableClientReporting: true
    },
    algolia: {
      appId: "MQ57UUUQZ2",
    ...
    datadog: {
      ...
      context: {
        deployment: {
          target: "production",
          tag: "main-20220329-025052-df36d6c591",
          commit: "df36d6c591725bae06592678ed718aefc2d90af9"
        }
      },
      datacenter: "us"
    },
    ...
    collectionStructuredData: {
      "8d6b8a439e32": {
        ...
        data: {
          ...
          ethicsPolicy:
            "https://help.medium.com/hc/en-us/articles/360043290473",
          logo: {
            "@type": "ImageObject",
    ...
    paypalClientId:
      "AXj1G4fotC2GE8KzWX9mSxCH1wmPE3nJglf4Z2ig_amnhvlMVX87otaq58niAg9iuLktVNF_1WCMnN7v",
    paypal: {
      ...
      monthlyPlan: {
        ...
        description:
          "Unlimited access to the best and brightest stories on Medium. Membership billed monthly."
      },
      yearlyPlan: {
        planId: "P-7N8963881P8875835MU5JOPQ",
        name: "Medium Membership (Annual) with setup fee",
        description:
          "Unlimited access to the best and brightest stories on Medium. Membership billed annually."
      },
      oneYearGift: {
        name: "Medium Membership (1 Year, Digital Gift Code)",
        description:
          "Unlimited access to the best and brightest stories on Medium. Gift codes can be redeemed at medium.com/redeem.",
        price: "50.00",
        currency: "USD",
  ...
  debug: {
    requestId: "e57741ed-ecd6-465e-9c08-0822f4580b8f",
    hybridDevServices: [],
    showBookReaderDebugger: false,
    originalSpanCarrier: {
      "ot-tracer-spanid": "593941175fcb01fa",
      "ot-tracer-traceid": "30c41ef16dcff44e",
  ...
  navigation: {
    branch: {
      ...
      data: {
        ...
        is_logged_in: true,
        is_member: false,
        user_created_at: 1570254183766,
        medium_member_at: "Null",
        post_topic_name: "Null",
        post_topic_slug: "Null",
        post_publication_name: "Null",
        post_publication_id: "Null",
        num_nonmoc_posts_in_month: 0,
        num_posts_in_day: 0,
        num_posts_in_week: 0,
        num_posts_in_month: 0,
        post_creator_name: "Null",
    ...
    currentLocation: "https://medium.com/",
    host: "medium.com",
    hostname: "medium.com",
    referrer: "",
  ...
  tracing: {},
  userOnboarding: {
    showFirstBookPurchaseTooltip: false
  }
};
